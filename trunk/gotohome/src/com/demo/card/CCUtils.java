...
public class CCUtils {
	...
	private static final String[] cardTypes = { "VI", "MC", "AX", "ER", "DN", };
	/**
	...
	public static String getCardType(int id) {
		return (id > -1 && id < cardNames.length ? cardTypes[id] : "");
	}
